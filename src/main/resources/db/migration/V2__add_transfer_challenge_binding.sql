...
alter table mfa_challenges add column reservation_request_id varchar(128);
alter table mfa_challenges add column decision_id varchar(128);
alter table mfa_challenges add column decision_request_id varchar(128);
alter table mfa_challenges add column customer_id varchar(255);
...
alter table mfa_challenges
    add constraint ck_mfa_challenges_transfer_binding check (
        (transfer_id is null and reservation_request_id is null and decision_id is null
            and decision_request_id is null and customer_id is null
        ...
        or (transfer_id is not null and reservation_request_id is not null and decision_id is not null
            and decision_request_id is not null and customer_id is not null
